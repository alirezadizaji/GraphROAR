...
class Entrypoint(GNNExplainerEntrypoint):
    def __init__(self):
        conf = GNNExplainerConfig(
            ...
            edge_mask_save_dir=os.path.join('..', 'data', 'ba_2motifs', 'explanation', 'gcn3l', 'gnnexplainer'),
        ...
        model.load_state_dict(torch.load('../1_gcn3l_BA2Motifs/weights/16', map_location=conf.device))
